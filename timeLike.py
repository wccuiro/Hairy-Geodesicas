...
plt.savefig(f'./Figures/alpha={miParticula.alpha}_eta={miParticula.eta}_nu={miParticula.nu}/timeLike_orbits/E={miParticula.energia}-{miParticula1.energia}-{miParticula2.energia}_J={miParticula.J}.svg')
